...
const MobileFilterPopup = ({ open, onClose, maxPrice }) => {
  ...
  const [price, setPrice] = useState([MIN_PRICE, maxPrice]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex md:hidden">
      ...
      <div className="relative w-4/5 max-w-xs bg-[#f1f3f6] h-full p-0 animate-slideInLeft overflow-y-auto flex flex-col">
